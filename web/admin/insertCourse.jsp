...
<body>
<form class="layui-form" action="${ctx}/CourseServlet?action=insertCourse" method="post">
    <div>
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-block">
            <input type="text" name="number" class="layui-input" required lay-verify="required" placeholder="请输入课程号"
                   autocomplete="off"/>
        </div>
    </div>
    <div class="layui-form-item">
